  ...
  return (
    <div>
      ...
      <Container>
        <section>
          <Box sx={{ mt: 10 }}>
            <Typography variant="h3" sx={{ mb: 5 }} className="titleText">
              projetos details
            </Typography>
            <Typography variant="body1" sx={{ mb: 2 }} className="bodyText">
        ...
        <section>
          <Box sx={{ mt: 5 }}>
            <Typography variant="h6">Público atingido:</Typography>
          </Box>
          <Box sx={{ mt: 5 }} className="card-img-display">
            {imgProjetosDetails.map((item) => (
...
export default ProjetosDetails;
